"""In-memory metrics for the Jev Hermes plugin.
...
_counters: Dict[str, int] = {
    "decisions": 0,           # total Jev API calls
    "tool_calls": 0,          # jev_decide tool invocations
    ...
    "compaction_runs": 0,     # committed Jev compaction passes
